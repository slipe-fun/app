...
export const tokens = createTokens({
  ...
  color: {
    ...
    lessGlassButtonDark: 'rgba(31, 31, 31, 0.6)',
    lessGlassButtonLight: 'rgba(224, 224, 224, 0.6)',
    red: '#FF1A1A',
...
const configUI = createTamagui({
  ...
  themes: {
    light: {
      ...
      lessGlassButton: tokens.color.lessGlassButtonLight,
    ...
    dark: {
      ...
      primary: tokens.color.primary,
      glassButton: tokens.color.glassButton,
      lessGlassButton: tokens.color.lessGlassButtonDark,
