...
import Animated, { useSharedValue, useAnimatedProps, useAnimatedStyle, withSpring, interpolate } from "react-native-reanimated";
...
const CaptureCamera = () => {
	...
	return (
		<GestureDetector gesture={gesture}>
			<View ref={ref} f={1} br='$7' position='relative' justifyContent='center' overflow='hidden'>
				<View position='absolute' top={0} left={0} right={0} bottom={0} br='$7' borderWidth={1} borderColor='rgba(255,255,255,0.2)' zIndex='$2' />
				<AnimatedView style={animatedCameraWrapperStyle}>
